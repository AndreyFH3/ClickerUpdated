...
public class GameLogic : MonoBehaviour
{
    ...
    private void eventMoneyAdd()
    {
        AddMoney((ulong)(_moneyPerSecond * MathF.Pow(1.07f, YandexGame.savesData.level)));
        YandexGame.savesData.moneyPerLevel += (ulong)(_moneyPerSecond * MathF.Pow(1.07f, YandexGame.savesData.level));
    }
}
